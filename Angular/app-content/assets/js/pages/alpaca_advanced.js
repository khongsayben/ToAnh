...
$(function() {
    ...
    $("#alpaca-option-tree-connector").alpaca({
        "schemaSource": "../AdminLayout/assets/demo_data/alpaca/optiontree-custom-schema.json",
        "optionsSource": "../AdminLayout/assets/demo_data/alpaca/optiontree-custom-options.json",
        "options": {
            "focus": false
        }
    });
